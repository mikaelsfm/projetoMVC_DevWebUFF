        ...
        <div class="container">
            ...
            <div class="mt-5">
                ...
                <div class="card mb-2 col-sm-6">
                    <div class="card-body">
                        <strong>Número:</strong> <%= comentario.getId()%><br>
                        <%= comentario.getComentario()%><br>
                        <strong>Categoria:</strong> <%= comentario.getCategoria()%><br>
                        <strong>Postado por:</strong> <%= comentario.getNomeAdministrador()%> <strong>em</strong> <%= comentario.getData()%>
                    </div>
                </div>
